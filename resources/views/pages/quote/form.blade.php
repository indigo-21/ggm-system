    ...
    <div class="container">
        <form id="form_validation" method="POST"
                ...
                <div class="col-12">
                    <div class="card top_widget">
                        ...
                        <div class="body row">
                            ...
                            <div class="col-6">
                                <x-input type="text" name="date_of_death" value="" class="daterange"
                                    label="Date of Death" />
                            </div>
                        ...
                        <div class="body row">
                            <div class="col-6 row px-5">
                                <div class="col-12 row">
                                    ...
                                    <div class="col-5">
                                        <x-input type="text" class="text-right" name="price_amount" value="0.00" label="Price Amount" />
                                    </div>
                                </div>
                                <div class="col-12 row">
                                    <div class="col-2">
                                ...
                                <div class="col-12 row">
                                    <div class="offset-7 col-5">
                                        <x-input type="text" class="text-right" name="total_amount" value="0.00" label="Total" />
                                    </div>
                                </div>
            ...
            <div class="mb-3 d-flex justify-content-center align-items-center">
                ...
                @endisset
                <button class="btn btn-primary hidden-xs w-25 ml-2"
                    type="submit">{{ !isset($quote) ? 'Create' : 'Update' }}</button>
            </div>
        </form>
    </div>
